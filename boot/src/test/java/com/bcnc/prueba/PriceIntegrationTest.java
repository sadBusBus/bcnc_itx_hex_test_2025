...
@ActiveProfiles("test")
@Sql(
    scripts = "/data/insert_test_prices.sql",
...
class PriceIntegrationTest {
  ...
  void setUp() {
    ...
    module.addDeserializer(
        ...
        new StdDeserializer<OffsetDateTime>(OffsetDateTime.class) {
  ...
  void shouldReturn404WhenPriceNotFound() {
    ...
    // Then
    assertEquals(
        HttpStatus.NOT_FOUND, errorResponse.getStatusCode(), "Expected HTTP 404 Not Found");
  }
}
