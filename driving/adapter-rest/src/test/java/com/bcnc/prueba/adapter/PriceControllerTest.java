...
class PriceControllerTest {
  ...
  @Mock private PriceServicePort priceServicePort;
  ...
  void shouldReturnFindPriceByDateProductAndBrandWhenValidParameters(
      String dateTime,
    ...
    when(priceServicePort.findPriceByDateProductAndBrand(requestDateTime, PRODUCT_ID, BRAND_ID))
        .thenReturn(price);
