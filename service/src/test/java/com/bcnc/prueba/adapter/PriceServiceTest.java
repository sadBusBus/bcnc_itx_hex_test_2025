...
class PriceServiceTest {
    ...
    private static Stream<Arguments> providePriceTestCases() {
        return Stream.of(
            ...
            Arguments.of("Test 1: petición a las 10:00 del día 14 del producto 35455 para la brand 1 (ZARA)",
                "2025-06-14T10:00:00Z", "1", "35.50"),
            Arguments.of("Test 2: petición a las 16:00 del día 14 del producto 35455 para la brand 1 (ZARA)",
                "2025-06-14T16:00:00Z", "2", "25.45"),
            Arguments.of("Test 3: petición a las 21:00 del día 14 del producto 35455 para la brand 1 (ZARA)",
                "2025-06-14T21:00:00Z", "1", "35.50"),
            Arguments.of("Test 4: petición a las 10:00 del día 15 del producto 35455 para la brand 1 (ZARA)",
                "2025-06-15T10:00:00Z", "3", "30.50"),
            Arguments.of("Test 5: petición a las 21:00 del día 16 del producto 35455 para la brand 1 (ZARA)",
                "2025-06-16T21:00:00Z", "4", "38.95")
        );
    }
