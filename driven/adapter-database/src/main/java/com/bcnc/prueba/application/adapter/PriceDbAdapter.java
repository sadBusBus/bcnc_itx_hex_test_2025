...
public class PriceDbAdapter implements PriceDbPort {
  ...
  public Price findPriceByDateProductAndBrand(
    ...
    Optional<PriceProjection> priceToReturn =
        repository.findPriceByDateProductAndBrand(dateTime, productId, brandId);
        ...
        .orElseThrow(
            () ->
                new NotFoundException(
                    PRICE_NOT_FOUND.name(), List.of(), PRICE_NOT_FOUND.getCode()));
  }
}
